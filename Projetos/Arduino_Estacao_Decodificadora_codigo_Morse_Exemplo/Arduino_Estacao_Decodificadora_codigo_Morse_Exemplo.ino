/**
 * Uma estação de código Morse para o Arduino Uno.
 * 
 * O visor é um OLED de 128*64 e utiliza as 
 * bibliotecas de drivers OLED da AdaFruit: 
 * - Adafruit GFX
 * - Adafruit SSD1306
 * 
 * Você pode procurar essas bibliotecas e instalá-las a partir do Arduino
 * IDE. No menu IDE, selecione Sketch->Incluir Biblioteca->Gerenciador de Bibliotecas
 * insira os nomes das bibliotecas acima e clique em instalar para cada uma delas.
 * 
 * Author: Carlos Alberto - Agosto - 2025
 */
#include <SPI.h>
#include <Wire.h>
...
void setup() {
  ...
  display.write("Estacao Codigo Morse");
